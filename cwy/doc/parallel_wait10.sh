...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# Kind1-34 分批启动测试 (每批10个，间隔2分钟，30轮完整测试)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
{
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🚀 Kind1-34 分批启动测试 (每批10个，间隔2分钟，30轮完整测试)"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "⏰ 开始时间: $(date '+%Y-%m-%d %H:%M:%S')"
echo "📁 日志目录: $LOG_DIR"
echo "🔢 测试轮数: $MAX_STEPS"
echo "📋 启动策略: 第1批(kind1-10) → 等待2分钟 → 第2批(kind11-20) → 等待2分钟 → 第3批(kind21-34)"
echo ""
} > "$MAIN_LOG"

echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}🚀 Kind1-34 分批启动测试 (每批10个，间隔2分钟)${NC}"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${YELLOW}📦 第1批: 启动 kind1-kind10${NC}"
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" >> "$MAIN_LOG"
echo "📦 第1批: 启动 kind1-kind10" >> "$MAIN_LOG"
echo "⏰ 时间: $(date '+%Y-%m-%d %H:%M:%S')" >> "$MAIN_LOG"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" >> "$MAIN_LOG"
...
echo ""
echo -e "${YELLOW}⏳ 等待 2 分钟后启动第2批...${NC}"
echo "⏳ 等待 2 分钟后启动第2批..." >> "$MAIN_LOG"
sleep 120
...
echo ""
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${YELLOW}📦 第2批: 启动 kind11-kind20${NC}"
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo "" >> "$MAIN_LOG"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" >> "$MAIN_LOG"
echo "📦 第2批: 启动 kind11-kind20" >> "$MAIN_LOG"
echo "⏰ 时间: $(date '+%Y-%m-%d %H:%M:%S')" >> "$MAIN_LOG"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" >> "$MAIN_LOG"

for cluster in kind{11..20}; do
    task="${CLUSTER_TASKS[$cluster]}"
    wrapper_script="/tmp/run_on_${cluster}_$$.sh"
    log_file="$LOG_DIR/task_${cluster}_${task}.log"
    pid_file="$LOG_DIR/task_${cluster}_${task}.pid"
...
echo ""
echo -e "${YELLOW}⏳ 等待 2 分钟后启动第3批...${NC}"
echo "⏳ 等待 2 分钟后启动第3批..." >> "$MAIN_LOG"
sleep 120
...
echo ""
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${YELLOW}📦 第3批: 启动 kind21-kind34${NC}"
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo "" >> "$MAIN_LOG"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" >> "$MAIN_LOG"
echo "📦 第3批: 启动 kind21-kind34" >> "$MAIN_LOG"
echo "⏰ 时间: $(date '+%Y-%m-%d %H:%M:%S')" >> "$MAIN_LOG"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" >> "$MAIN_LOG"

for cluster in kind{21..34}; do
    task="${CLUSTER_TASKS[$cluster]}"
    wrapper_script="/tmp/run_on_${cluster}_$$.sh"
    log_file="$LOG_DIR/task_${cluster}_${task}.log"
    pid_file="$LOG_DIR/task_${cluster}_${task}.pid"
